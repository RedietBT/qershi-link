...
/**
 * JPA Entity mapping sacco_xxx.account_audit_logs for loan account state transitions.
 *
...
public class LoanAuditLogEntity {
    ...
    public LoanAuditLogEntity() {}

    public LoanAuditLogEntity(UUID logId, String accountNo, UUID userId, UUID performedByUserId,
