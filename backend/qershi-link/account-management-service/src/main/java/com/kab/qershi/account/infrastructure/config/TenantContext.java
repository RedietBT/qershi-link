...
/**
 * Thread-isolated container managing the active tenant's database routing context for account service.
...
public final class TenantContext {
    ...
    /** Default fallback schema matching Flyway migration schema for account service components. */
    public static final String DEFAULT_TENANT = "account_schema";
