...
import { X, ShieldCheck, CheckCircle2, AlertCircle, RefreshCw, Key, Check } from 'lucide-react';
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <label className="block text-xs font-bold text-[var(--bdae-text-primary)] flex items-center gap-1.5">
                ...
                <span>Assigned Permissions ({selectedPermissionIds.length}/{permissions.length}) *</span>
              </label>
